...
var _function = require('mapbox-gl-style-spec/lib/function');
...
function preprocess(layer, onChange) {
  if ('layout' in layer && 'text-field' in layer.layout) {
    loadFont(layer.layout['text-font'] || _mapboxToOlStyle.defaults['text-font'], onChange);
  }
}
...
},{"mapbox-gl-style-spec/lib/function":3,"mapbox-to-css-font":4,"mapbox-to-ol-style":5,"webfontloader":7}],2:[function(require,module,exports){
'use strict';
    ...
    if (!isFunctionDefinition(parameters)) {
        ...
        if (zoomAndFeatureDependent) {
            ...
            fun = function (zoom, feature) {
                ...
                } else return outputFunction(innerFun(parameters, feature[parameters.property]));
            };
            fun.isFeatureConstant = false;
            fun.isZoomConstant = true;
        }
      ...
      if (!layer.filter || evaluate(layer.filter, properties)) {
        ...
        if (type != 'Point') {
          if (!('line-pattern' in paint) && 'line-color' in paint) {
            color = colorWithOpacity(paint['line-color'](zoom), paint['line-opacity'](zoom));
          }
          ...
          if (color && width > 0) {
            ...
            stroke.setLineDash(paint['line-dasharray'] ? paint['line-dasharray'](zoom).map(function (x) {
              return x * width;
            }) : null);
            style.setZIndex(i);
          }
        ...
        if (type == 'Point' && 'circle-radius' in paint) {
          ++stylesLength;
          var cache_key = paint['circle-radius'](zoom) + '.' + paint['circle-stroke-color'](zoom) + '.' + paint['circle-color'](zoom);
        ...
        if (label && type !== 'LineString') {
          ...
          var font = (0, _mapboxToCssFont2.default)(fontMap[paint['text-font'](zoom)], textSize);
...
},{"mapbox-gl-style-spec/lib/function":3,"mapbox-to-css-font":6,"ol/style/circle":"ol/style/circle","ol/style/fill":"ol/style/fill","ol/style/icon":"ol/style/icon","ol/style/stroke":"ol/style/stroke","ol/style/style":"ol/style/style","ol/style/text":"ol/style/text"}],6:[function(require,module,exports){
...
/* Web Font Loader v1.6.27 - (c) Adobe Systems, Google. License: Apache 2.0 */(function () {
  ...
  function B(a, b, c, d) {
    ...
    for (var b = [], c = 0; c < arguments.length; c++) b.push(arguments[c].replace(/[\W_]+/g, "").toLowerCase());return b.join(this.a);
  };function H(a, b) {
  ...
  sa.prototype.load = function (a) {
    ...
    var b,
        ...
        g = new C();b = 0;for (c = d.length; b < c; b++) A(this.c, d[b], D(g));var k = [];b = 0;for (c = e.length; b < c; b++) if (d = e[b].split(":"), d[1]) for (var h = d[1].split(","), m = 0; m < h.length; m += 1) k.push(new H(d[0], h[m]));else k.push(new H(d[0]));F(g, function () {
      a(k, f);
    });
  };function va(a, b, c) {
