 ...
 */
export function drawSDF(image: HTMLImageElement | HTMLCanvasElement, area: {
    x: number;
    y: number;
    width: number;
    height: number;
...
export const emptyObj: Readonly<{}>;
...
export type Source = import("ol/source/Source.js").default;
