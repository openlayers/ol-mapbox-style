 ...
 * @private
 */
export function setupVectorSource(glSource: any, styleUrl: string | undefined, options: Options): Promise<import("ol/source/VectorTile.js").default>;
export function setupLayer(glStyle: any, styleUrl: any, glLayer: any, options: any): Layer<Source, import("ol/renderer/Layer.js").default<any>, {
    [x: string]: any;
}> | undefined;
/**
 ...
 */
export function updateMapboxLayer(mapOrGroup: Map | LayerGroup, mapboxLayer: any): Promise<void>;
/**
 ...
 */
export function setFeatureState(mapOrLayer: Map | LayerGroup | VectorLayer | VectorTileLayer, feature: FeatureIdentifier, state: any | null): void;
/**
 * Sets or removes a feature state. The feature state is taken into account for styling,
 * just like the feature's properties, and can be used e.g. to conditionally render selected
 * features differently.
 ...
 * feature identifier.
 */
export function getFeatureState(mapOrLayer: Map | LayerGroup | VectorLayer | VectorTileLayer, feature: FeatureIdentifier): any | null;
...
export type Options = {
     ...
     */
    transformRequest?: ((arg0: string, arg1: import("./util.js").ResourceType) => (Request | string | Response | Promise<Request | string | Response> | void)) | undefined;
    /**
    ...
    /**
     * Use interpolated values when resampling raster sources. Can be
